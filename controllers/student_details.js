...
myfunctions.getStudents = function (req, res, next) {
    dbConn.rdb.then(function(con_rdb){
           con_rdb.query(db_model.sqlquery.getAllStudents, function (error, results, fields) {
            if (error) {
                console.log(error);
...
myfunctions.postStudents = function(req, res, next) {
    dbConn.rdb.then(function(con_rdb){
        con_rdb.query(db_model.sqlquery.insertStudents, db_model.datamodel.postStudents(req.body), function(error, results, fields){
            if(error){
                console.log(error);
